...
create or replace foreign table FY2007 ( obligatedAmount varchar(128) ,fiscalYear varchar(128) ,agencyID varchar(255)) server fpds_couch options (username '', password '', view '_design/fy2007/_view/fy2007');
